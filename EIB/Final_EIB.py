...
NumDev=360; #no. of mobile devices
PacketLenBytes=40;
...
def transmission_parameter(node_id):
    if node_id <10:
        SF=7
        return(SF)
    if ((node_id >9) and (node_id<40)):
        SF=8
        return(SF)
    if ((node_id >39) and (node_id<90)):
        SF=9
        return(SF)
    if ((node_id >89) and (node_id<160)):
        SF=10
        return(SF)
    if ((node_id >159) and (node_id<250)):
        SF=11
        return(SF)
    if ((node_id >249) and (node_id<360)):
        SF=12
        return(SF)
